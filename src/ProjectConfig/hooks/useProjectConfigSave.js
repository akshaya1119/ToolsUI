  ...
  const handleSave = async (overrideIsMasterConfig = false, overrideTypeId = null, overrideGroupId = null, skipChangeDetection = false) => {
    ...
    try {
      ...
      const projectConfigPayload = {
        ...
        boxBreakingCriteriaForUniExtra: selectedUniversityExtraBoxFields,
        boxBreakingCriteriaForOffcExtra: selectedOfficeExtraBoxFields,
        boxBreakingCriteriaForNodalExtra: selectedNodalExtraBoxFields,
