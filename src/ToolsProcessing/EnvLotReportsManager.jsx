...
const EnvLotReportsManager = ({ 
  ...
  const getGeneratedByName = (report) => {
    if (!report) return "-";
    const generatedByUserId = report.generatedByUserId || report.GeneratedByUserId;
    const fallbackName = report.generatedBy || report.GeneratedBy || "-";
    return (generatedByUserId ? getFirstNameFromUserId(generatedByUserId, userMap) : null) || fallbackName;
  };
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 1 }}>
                ...
                <Text type="secondary" style={{ fontSize: "10px" }}>
                  by {getGeneratedByName(latestReport)} • {formatDateTime(latestReport.generatedAt)}
                </Text>
              </div>
            </div>
            <Button
